...
<div>
    ...
    <input type="hidden" name="type" id="question-type" value="multiple_response">
</div>
                ...
                <div class="question-option-container">
                    ...
                    <div class="text-center">
                        <label for="option_answer_1">
                            <input id="option_answer_1" name="option_answer_correct[]" type="checkbox" value="1">
                        </label>
                    </div>
                </div>
            </div>
                ...
                <div class="question-option-container">
                    ...
                    <div class="text-center">
                        <label for="option_answer_2">
                            <input id="option_answer_2" name="option_answer_correct[]" type="checkbox" value="2">
                        </label>
                    </div>
                </div>
            </div>
                ...
                <div class="question-option-container">
                    ...
                    <div class="text-center">
                        <label for="option_answer_3">
                            <input id="option_answer_3" name="option_answer_correct[]" type="checkbox" value="3">
                        </label>
                    </div>
                </div>
            </div>
                ...
                <div class="question-option-container">
                    ...
                    <div class="text-center">
                        <label for="option_answer_4">
                            <input id="option_answer_4" name="option_answer_correct[]" type="checkbox" value="4">
                        </label>
                    </div>
                </div>
            </div>
...
<script>
    ...
    $("#add-new-option").click(function(event){
        ...
        var template = '<div class="form-group row">\n' +
            ...
            '                            <input id="option_answer_'+ option_index +'" name="option_answer_correct[]" type="checkbox" value="'+ option_index +'">\n' +
            '                        </label>\n' +
            '                    </div>\n' +
            '                </div>\n' +
            '            </div>\n' +
