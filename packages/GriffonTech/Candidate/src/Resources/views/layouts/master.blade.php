...
<head>
    ...
    <title> {{ config('app.name') }} | Candidate | @yield('page_title') </title>
...
@include('candidate::layouts.header.index')

@include('candidate::layouts.sidebar.index')
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        ...
                        <p> Last seen : <span>20-02-2021 10:00:00 AM</span></p>
                    </div>&lt;!&ndash; /.col &ndash;&gt;
                </div>&lt;!&ndash; /.row &ndash;&gt;
...
@include('candidate::layouts.footer.index')
